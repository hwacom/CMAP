...
<!-- Modal [viewPortNumberDetail] start -->
<div class="modal fade" id="viewPortNumberDetailModal" tabindex="-1" role="dialog" aria-labelledby="viewPortNumberDetailLabel" aria-hidden="true">
  <div class="modal-dialog modal-mid" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="viewPortNumberDetailLabel"><span id="msgModal_title">連線明細資料</span></h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
     	<div class="form-group row">
        	<label for="viewPortNumberDetailModal_groupName" class="col-md-2 col-sm-12 col-form-label"><spring:message code="group.name" /> :</label>
    		<div class="form-control form-control-sm col-md-10 col-sm-12" id="viewPortNumberDetailModal_groupName"></div>
        </div>
        <div class="form-group row">
        	<label for="viewPortNumberDetailModal_clientIp" class="col-md-2 col-sm-12 col-form-label"><spring:message code="wifi.poller.client.ip" /> :</label>
    		<div class="form-control form-control-sm col-md-10 col-sm-12" id="viewPortNumberDetailModal_clientIp"></div>
        </div>
        <div class="form-group row">
        	<label for="viewPortNumberDetailModal_pollingTime" class="col-md-2 col-sm-12 col-form-label"><spring:message code="wifi.poller.polling.time" /> :</label>
    		<div class="form-control form-control-sm col-md-10 col-sm-12" id="viewPortNumberDetailModal_pollingTime"></div>
        </div>
        <div class="form-group row">
        	<label for="viewPortNumberDetailModal_uploadSize" class="col-md-2 col-sm-12 col-form-label"><spring:message code="wifi.poller.traffic.chart" /> :</label>
    		<div class="form-control form-control-sm col-md-10 col-sm-12" id="viewPortNumberDetailModal_uploadSize"></div>
    		<label for="viewPortNumberDetailModal_uploadSession" class="col-md-2 col-sm-12 col-form-label"><spring:message code="wifi.poller.traffic.chart" /> :</label>
    		<div class="form-control form-control-sm col-md-10 col-sm-12" id="viewPortNumberDetailModal_uploadSession"></div>
        </div>
        <div class="form-group row">
        	<label for="viewPortNumberDetailModal_downloadSize" class="col-md-2 col-sm-12 col-form-label"><spring:message code="wifi.poller.traffic.chart" /> :</label>
    		<div class="form-control form-control-sm col-md-10 col-sm-12" id="viewPortNumberDetailModal_downloadSize"></div>
    		<label for="viewPortNumberDetailModal_downloadSession" class="col-md-2 col-sm-12 col-form-label"><spring:message code="wifi.poller.traffic.chart" /> :</label>
    		<div class="form-control form-control-sm col-md-10 col-sm-12" id="viewPortNumberDetailModal_downloadSession"></div>
        </div>
      </div>
      <div class="modal-footer">
      </div>
