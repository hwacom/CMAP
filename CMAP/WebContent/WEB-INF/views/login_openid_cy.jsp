...
<html>
  <head>
    ...
    <link rel="icon" href="${pageContext.request.contextPath}/resources/images/cnc.ico">
            ...
            <div class="col-12">
	  			<div class="row">
			  		<div class="col-md-6 col-sm-12 offset-md-3 m-t-5 login-title">
			  			<img class="img" src="${pageContext.request.contextPath}/resources/images/cnc.png" width="auto" height="40" style="padding-top: 3px" />
      					<!-- <img class="img web-only" src="${pageContext.request.contextPath}/resources/images/cnc.png" width="auto" height="40" style="padding-top: 3px" /> -->
      					<span class="h3 font-weight-bold" style="color:#1C2269"><spring:message code="cy.title" /></span>
			  	...
			  	<div class="row">
			  		<div class="col-md-6 col-sm-12 offset-md-3 m-t-5 login-form">
						  ...
						  <div class="col-12">
						  	<img src="${pageContext.request.contextPath}/resources/images/cnc.png" style="float: left; margin: 15px; witdh: 64px; height: 64px;"/>
  ...
  <script>
	  $(document).ready(function() {
		  $("#btnLogin").click(function(e) {
			 location.href = "${pageContext.request.contextPath}/login/authByOIDC_CY";
		  });
	  });
  </script>
</html>
