...
$(document).ready(function() {
	initMenuStatus("toggleMenu_prtg", "toggleMenu_prtg_items", "cm_netflowtrace");
...
function doDataExport(exportRecordCount) {
	...
	$.ajax({
		url : _ctx + '/plugin/module/netFlowTrace/dataExport.json',
		data : dataObj,
		type : "POST",
		dataType : 'json',
		async: true,
...
function getTotalTraffic() {
	...
	$.ajax({
		url : _ctx + '/plugin/module/netFlowTrace/getTotalTraffic.json',
		data : {
...
function getTotalFilteredCount() {
	$.ajax({
		url : _ctx + '/plugin/module/netFlowTrace/getTotalFilteredCount.json',
		data : {
			"queryGroup" : $("#queryGroup").val(),
			"querySourceIp" : $("#query_SourceIp").val(),
			"queryDestinationIp" : $("#query_DestinationIp").val(),
...
function findNextData() {
	...
	$.ajax({
		url : _ctx + '/plugin/module/netFlowTrace/getNetFlowData.json',
		data : {
			"queryGroup" : $("#queryGroup").val(),
			"querySourceIp" : $("#query_SourceIp").val(),
			"queryDestinationIp" : $("#query_DestinationIp").val(),
