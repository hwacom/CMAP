...
$(document).ready(function() {
	initMenuStatus("toggleMenu_admin", "toggleMenu_admin_items", "bk_login");
...
function findData(from) {
	...
	if (typeof resultTable !== "undefined") {
		...
		resultTable = $('#resultTable').DataTable(
		{
			...
			"ajax" : {
				"url" : _ctx + '/admin/loginInfo/getLoginInfoData.json',
				"type" : 'POST',
				"data" : function ( d ) {
					if ($('#queryFrom').val() == 'WEB') {
						...
						d.queryUserAccount = $("#queryUserAccount").val();
...
//				getTotalFilteredCount();
			...
			"columns" : [
				...
				{ "data" : "ipAddr" , "orderable" : false },
				{ "data" : "account" , "orderable" : false },
				{ "data" : "userName" , "orderable" : false },
				{ "data" : "loginTimeStr" , "orderable" : false },
				{ "data" : "logoutTimeStr" , "orderable" : false }
			],
			"columnDefs" : [
				{
					"targets" : [0],
...
function doDataExport(exportRecordCount) {
	...
	if ($('#queryFrom').val() == 'WEB') {
		...
		dataObj.queryUserAccount = $("#queryUserAccount").val();
	...
	$.ajax({
		url : _ctx + '/admin/loginInfo/dataExport.json',
		data : dataObj,
		type : "POST",
		dataType : 'json',
		async: true,
