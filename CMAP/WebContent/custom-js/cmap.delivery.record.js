				...
				},
				{
					...
					"render" : function(data, type, row) {
						...
						switch (row.deliveryResult) {
							case "SUCCESS":
								html = '<button name="btn_viewLog" class="btn btn-success" onclick="viewProvisionLog(this)" data-step-id="' + row.logStepId + '">成功</button>';
								break;
								
							case "NO_DIFFERENT":
								html = '<button name="btn_viewLog" class="btn btn-primary" onclick="viewProvisionLog(this)" data-step-id="' + row.logStepId + '">無差異</a>';
								break;
