	...
	public void execute(JobExecutionContext context) throws JobExecutionException {
		...
		try {
			...
			if (actionFlag) {
				...
				final String limitSizeUnit = commonService.convertByteSizeUnit(new BigDecimal(Env.ABNORMAL_NET_FLOW_LIMIT_BLOCK_SIZE), Env.NET_FLOW_LIMIT_BLOCK_UNIT_OF_TOTOAL_FLOW).replace(" ", "");
			...
			super.insertSysJobLog(JOB_ID, context, nfVO.getJobExcuteResult(), nfVO.getJobExcuteResultRecords(),
					startTime, endTime, nfVO.getJobExcuteRemark());
		}
	}
}
