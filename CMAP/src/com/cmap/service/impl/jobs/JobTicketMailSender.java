...
public class JobTicketMailSender extends BaseJobImpl implements BaseJobService {
    private static Logger log = LoggerFactory.getLogger(JobTicketMailSender.class);
