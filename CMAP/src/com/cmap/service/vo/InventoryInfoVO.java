...
public class InventoryInfoVO extends CommonServiceVO {
	...
	public InventoryInfoVO(String queryDevice, List<String> queryDeviceList, String queryProbe, String queryDeviceName,
			String queryDeviceType, String queryBrand, String queryModel, String deviceId, String probe,
			String groupName, String deviceName, String deviceIp, String deviceType, String brand, String model,
			String systemVersion, String serialNumber, String manufactureDate, Timestamp createTime,
			String createTimeStr, String createBy, Timestamp updateTime, String updateBy, String modifyProbe,
			String modifyGroup, String modifyDeviceName, String modifyDeviceIp, String modifyDeviceType,
			String modifyBrand, String modifyModel, String modifySystemVersion, String modifySerialNumber,
			String modifyManufactureDate) {
		super();
