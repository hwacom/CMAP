...
@Entity
@Table(name="module_blocked_mac_list")
public class ModuleBlockedMacList implements java.io.Serializable {
    ...
    public ModuleBlockedMacList() {
        super();
    }

    public ModuleBlockedMacList(String listId, String groupId, String deviceId, String macAddress,
