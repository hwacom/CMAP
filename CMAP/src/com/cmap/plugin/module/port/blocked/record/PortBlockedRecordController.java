...
@Controller
@RequestMapping("/plugin/module/portBlockedRecord")
public class PortBlockedRecordController extends BaseController {
    @Log
    private static Logger log;

    @Autowired
    private PortBlockedRecordService portBlockedRecordService;
    ...
    public String portRecord(Model model, Principal principal, HttpServletRequest request, HttpServletResponse response) {
        ...
        return "plugin/module_port_blocked_record";
    }
}
