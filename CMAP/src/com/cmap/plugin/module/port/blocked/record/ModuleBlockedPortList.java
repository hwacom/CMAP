...
@Entity
@Table(name="module_blocked_port_list")
public class ModuleBlockedPortList implements java.io.Serializable {
    ...
    public ModuleBlockedPortList() {
        super();
    }

    public ModuleBlockedPortList(String listId, String groupId, String deviceId, String portId,
