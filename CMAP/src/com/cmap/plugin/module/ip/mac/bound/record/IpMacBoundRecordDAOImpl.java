...
@Repository("ipMacRecordDAO")
@Transactional
public class IpMacBoundRecordDAOImpl extends BaseDaoHibernate implements IpMacBoundRecordDAO {
    @Log
    ...
    public long countModuleIpMacBoundList(IpMacBoundRecordVO ibrVO) {
        ...
        sb.append(" select count(mbil.list_Id) ")
          .append(" from module_ip_mac_bound_list mbil ")
...
//        }
        ...
        if (StringUtils.isNotBlank(ibrVO.getQueryMacAddress())) {
            sb.append(" and mbil.mac_Address = :macAddress ");
        }
...
//        q.setParameter("groupId", StringUtils.isNotBlank(ibrVO.getQueryGroupId()) ? ibrVO.getQueryGroupId() : ibrVO.getQueryGroupIdList());
    ...
    public List<Object[]> findModuleIpMacBoundList(IpMacBoundRecordVO ibrVO, Integer startRow, Integer pageLength) {
        ...
        sb.append(" select ")
          ...
          .append("  ,mids.ip_desc ")
          .append("  ,mbil.mac_address ")
          .append("  ,mbil.port ")
          .append("  ,mbil.globalValue ")
...
//        }
        ...
        if (StringUtils.isNotBlank(ibrVO.getQueryMacAddress())) {
            sb.append(" and mbil.macAddress = :macAddress ");
        }
        if (ibrVO.getQueryStatusFlag() != null && !ibrVO.getQueryStatusFlag().isEmpty()) {
...
//        q.setParameter("groupId", StringUtils.isNotBlank(ibrVO.getQueryGroupId()) ? ibrVO.getQueryGroupId() : ibrVO.getQueryGroupIdList());
        ...
        List<ModuleIpMacBoundList> entities = (List<ModuleIpMacBoundList>)q.list();
