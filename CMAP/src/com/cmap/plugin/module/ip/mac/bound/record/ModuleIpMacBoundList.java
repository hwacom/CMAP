...
@Entity
@Table(name="module_ip_mac_bound_list")
public class ModuleIpMacBoundList implements java.io.Serializable {
    ...
    public ModuleIpMacBoundList() {
        super();
    }

	public ModuleIpMacBoundList(String listId, String groupId, String deviceId, String ipAddress, String macAddress,
			String port, String globalValue, String statusFlag, Timestamp blockTime, String blockBy,
			String blockReason, Timestamp openTime, String openBy, String openReason, String scriptCode,
			String scriptName, String remark, Timestamp createTime, String createBy, Timestamp updateTime,
			String updateBy) {
        super();
        this.listId = listId;
